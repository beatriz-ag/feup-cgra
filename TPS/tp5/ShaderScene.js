...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/tp5a.vert", "shaders/tp5a.frag"),
			new CGFshader(this.gl, "shaders/tp5b.vert", "shaders/tp5b.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/tp5c.frag"),
			new CGFshader(this.gl, "shaders/waterTex.vert", "shaders/waterTex.frag")
