...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.woodMaterial.setAmbient(0.82, 0.59, 0.31, 1.0);
        this.woodMaterial.setDiffuse(0.82, 0.59, 0.31, 1.0);
        this.woodMaterial.setSpecular(0, 0, 0, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.R, this.G, this.B, 1.0);
