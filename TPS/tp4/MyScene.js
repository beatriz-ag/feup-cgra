...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.myUnitQuad = new MyUnitCubeQuad(this, [this.top, this.front, this.back, this.left, this.right, this.bottom]);

        /**
         * Objects
         */
        this.selectedObject = -1;
        this.objectsIds = { 'Quad': 0, 'Tangram': 1, 'Unit Quad': 2 };
        this.objects = [this.quad, this.myTangram, this.myUnitQuad];
